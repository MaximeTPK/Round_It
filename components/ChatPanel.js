...
// Parse une heure "09:00" ou "9:00" ou "9h00" → minutes depuis minuit
...
// Parse un booléen ("oui", "yes", "true", "1", "strict" → true)
...
export function parsePickingCSV(text) {
  ...
  for (const row of data) {
    ...
    // Si plusieurs lignes, prendre la fenêtre la plus large
